...
const ALL_STEPS: TourStepDef[] = [
  ...
  },
  {
    id: "pods",
    title: "Pod selection",
    description: "Filter SRKW, Transient, or Both.",
    detail: "Handy when you’re tracking a specific pod.",
    targetSelector: '[data-tour="pods"]',
    side: "left",
    align: "center",
    offset: 10,
  },
  {
    id: "historic",
    title: "Historic sightings",
    description: "Toggle historic sightings for the selected period.",
    detail: "Use this to add long-term context to the forecast.",
    targetSelector: '[data-tour="historic"]',
    side: "left",
    align: "center",
    offset: 10,
  },
  ...
  },
  {
    id: "hotspots",
    title: "Hotspots",
    description: "Toggle the hotspots-only view.",
